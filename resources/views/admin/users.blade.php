                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <p class="text-sm text-gray-600 mb-3">Import multiple users from CSV/XLSX</p>
                            <a href="{{ route('admin.users.import') }}" class="w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 text-sm block text-center">
                                Import Users
                            </a>
                        </div>
